...
void DisplayBwl(void)
{
    ...
    // Display Battle Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(3 + sub_80AEBEC(stats->battleAmt), 14),
        TEXT_COLOR_SYSTEM_BLUE, stats->battleAmt);

    // Display Win Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(7 + sub_80AEBEC(stats->winAmt), 14),
        TEXT_COLOR_SYSTEM_BLUE, stats->winAmt);

    // Display Loss Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(11 + sub_80AEBEC(stats->lossAmt), 14),
