...
_080118A0: .4byte Sprite_16x8
_080118A4: .4byte Sprite_8x8
_080118A8:
	lsls r0, r5, #3
	ldr r1, [r6, #0x30]
	adds r1, r1, r0
...
_08011900:
	...
	b _0801192C
	.align 2, 0
_08011904: .4byte Sprite_16x8
_08011908: .4byte Sprite_8x8
_0801190C:
	lsls r0, r5, #3
	ldr r1, [r6, #0x30]
	adds r1, r1, r0
...
_080119D8:
	...
	bx r0
	.align 2, 0
_08011A0C: .4byte Sprite_16x8
_08011A10: .4byte Sprite_8x8
_08011A14: .4byte Sprite_32x16
...
sub_8011BA4: @ 0x08011BA4
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _08011C84  @ Pal_SystemText
	ldr r1, [r7, #0x3c]
	adds r1, #0x11
	lsls r1, r1, #5
	movs r2, #0x20
...
_08011C84: .4byte Pal_SystemText
...
sub_8011DF4: @ 0x08011DF4
	...
	adds r7, r0, #0
	mov r8, r1
	ldr r5, _08011E38  @ gBattleUnitA
	adds r0, r5, #0
	adds r1, r7, #0
	bl InitBattleUnit
	ldr r4, _08011E3C  @ gBattleUnitB
	adds r0, r4, #0
	mov r1, r8
	bl InitBattleUnit
...
_08011E24:
	...
	b _08011E48
	.align 2, 0
_08011E38: .4byte gBattleUnitA
_08011E3C: .4byte gBattleUnitB
...
_08011E48:
	...
	cmp r0, #0
	beq _08011E68
	ldr r0, _08011E64  @ gBattleUnitA
	bl SetBattleUnitWeaponBallista
	b _08011E72
	.align 2, 0
_08011E60: .4byte gBattleStats
_08011E64: .4byte gBattleUnitA
_08011E68:
	ldr r0, _08011EC0  @ gBattleUnitA
	movs r1, #1
	negs r1, r1
	bl SetBattleUnitWeapon
_08011E72:
	ldr r4, _08011EC4  @ gBattleUnitB
	movs r1, #1
	negs r1, r1
	adds r0, r4, #0
	bl SetBattleUnitWeapon
	bl BattleInitTargetCanCounter
	ldr r5, _08011EC0  @ gBattleUnitA
	adds r0, r5, #0
	adds r1, r4, #0
	...
	bx r0
	.align 2, 0
_08011EC0: .4byte gBattleUnitA
_08011EC4: .4byte gBattleUnitB
...
_08011FE2:
	...
	b _0801209C
	.align 2, 0
_08012028: .4byte gBattleUnitA
_0801202C: .4byte gBattleUnitB
...
_0801207C:
	...
	b _080120BE
	.align 2, 0
_08012098: .4byte gBattleUnitA
_0801209C:
	ldr r0, _08012150  @ gBattleUnitA
	movs r1, #0x80
	lsls r1, r1, #1
	adds r2, r6, r1
	adds r1, r0, #0
...
_08012118:
	...
	b _080121BA
	.align 2, 0
_08012150: .4byte gBattleUnitA
_08012154: .4byte gBattleStats
_08012158: .4byte gBattleUnitB
_0801215C: .4byte gBattleHitIterator
_08012160: .4byte gAction
...
_0801216C:
	...
	beq _080121A0
_08012192:
	ldr r1, _0801219C  @ gAction
	movs r0, #3
	b _080121A4
	.align 2, 0
_08012198: .4byte gActiveUnit
_0801219C: .4byte gAction
_080121A0:
	ldr r1, _080121CC  @ gAction
	movs r0, #2
_080121A4:
	strb r0, [r1, #0x11]
	ldr r1, [sp]
...
sub_80121D4: @ 0x080121D4
	push {r4, r5, r6, r7, lr}
	ldr r5, _08012258  @ gBattleUnitA
	movs r0, #0xb
	ldrsb r0, [r5, r0]
	bl GetUnit
	adds r6, r0, #0
	ldr r4, _0801225C  @ gBattleUnitB
	movs r0, #0xb
	ldrsb r0, [r4, r0]
	bl GetUnit
	adds r7, r0, #0
...
_08012248:
	...
	bx r0
	.align 2, 0
_08012258: .4byte gBattleUnitA
_0801225C: .4byte gBattleUnitB
_08012260: .4byte gAction
...
sub_8012270: @ 0x08012270
	...
	movs r3, #0
	bl UnitPromote
	ldr r1, _08012318  @ gBattleUnitA
	ldr r0, _0801231C  @ gBattleUnitB
	adds r0, #0x4a
	strh r5, [r0]
	adds r1, #0x4a
	strh r5, [r1]
...
_08012318: .4byte gBattleUnitA
_0801231C: .4byte gBattleUnitB
...
StoreUnitWordStructs: @ 0x0801263C
	push {r4, r5, lr}
	ldr r4, _08012674  @ gSomeUnitWordArray
	movs r5, #1
_08012642:
	adds r0, r5, #0
	bl GetUnit
...
_08012662:
	...
	bx r0
	.align 2, 0
_08012674: .4byte gSomeUnitWordArray
...
LoadUnitWordStructs: @ 0x08012678
	push {r4, lr}
	ldr r4, _08012680  @ gSomeUnitWordArray
	b _080126B0
	.align 2, 0
_08012680: .4byte gSomeUnitWordArray
_08012684:
	ldrb r0, [r4]
	bl GetUnitByPid
	adds r2, r0, #0
