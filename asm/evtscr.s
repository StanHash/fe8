...
Event01_End: @ 0x0800D5A4
	...
	movs r0, #0xf
	ands r0, r1
	ldr r7, _0800D62C  @ gEventCallStack
	cmp r0, #1
	bne _0800D5E2
	movs r2, #0
	adds r6, r7, #0
...
_0800D5F4:
	...
	b _0800D66A
	.align 2, 0
_0800D62C: .4byte gEventCallStack
_0800D630:
	adds r2, r3, #0
	adds r2, #0x41
	ldrb r0, [r2]
...
_0800D9D4:
	movs r0, #7
	ldr r1, _0800DA28  @ gEventCallStack
	mov r8, r1
	mov ip, r8
	movs r7, #4
	add r7, r8
...
_0800DA28: .4byte gEventCallStack
...
_0800E718: .4byte gEvent1EData
_0800E71C:
	ldr r1, _0800E738  @ gEvent1EData
	adds r0, r2, #0
	adds r0, #8
	movs r2, #0
	strb r0, [r1]
...
_0800E842:
	...
	bl EnableBgSync
	bl EnablePalSync
	ldr r1, _0800E89C  @ gPal
	movs r0, #0
	strh r0, [r1]
	b _0800E8BE
	.align 2, 0
_0800E894: .4byte gUnknown_0895DD1C
_0800E898: .4byte gBg3Tm
_0800E89C: .4byte gPal
_0800E8A0:
	movs r0, #3
	bl GetBgChrOffset
	adds r1, r0, #0
	ldr r0, _0800E8C8  @ gBg3Tm
	str r6, [sp]
	movs r2, #8
	movs r3, #8
	bl sub_80B65F8
...
_0800EC94:
	...
	bl EnableBgSync
	bl EnablePalSync
	ldr r1, _0800ECFC  @ gPal
	movs r0, #0
	strh r0, [r1]
	b _0800ED20
	.align 2, 0
_0800ECF4: .4byte gUnknown_0895DD1C
_0800ECF8: .4byte gBg2Tm
_0800ECFC: .4byte gPal
_0800ED00:
	movs r0, #2
	bl GetBgChrOffset
	adds r1, r0, #0
	ldr r0, _0800ED48  @ gBg2Tm
	ldrh r2, [r6, #0x2c]
	str r2, [sp]
	movs r2, #0
	movs r3, #6
...
_0800ED20:
	...
	bx r0
	.align 2, 0
_0800ED48: .4byte gBg2Tm
_0800ED4C: .4byte gDispIo
...
_0800ED94:
	...
	bl EnableBgSync
	bl EnablePalSync
	ldr r1, _0800EE00  @ gPal
	movs r0, #0
	strh r0, [r1]
	b _0800EE24
	.align 2, 0
_0800EDF8: .4byte gUnknown_0895DD1C
_0800EDFC: .4byte gBg3Tm
_0800EE00: .4byte gPal
_0800EE04:
	movs r0, #3
	bl GetBgChrOffset
	adds r1, r0, #0
	ldr r0, _0800EE4C  @ gBg3Tm
	ldrh r2, [r6, #0x2c]
	str r2, [sp]
	movs r2, #8
	movs r3, #6
...
_0800EE24:
	...
	bx r0
	.align 2, 0
_0800EE4C: .4byte gBg3Tm
_0800EE50: .4byte gDispIo
...
_0800EF6A:
	...
	b _0800EFE2
	.align 2, 0
_0800EF8C: .4byte gDispIo
_0800EF90:
	ldr r2, _0800EFB8  @ gDispIo
	ldrb r1, [r2, #1]
	movs r0, #2
	negs r0, r0
	ands r0, r1
	...
	b _0800EFE2
	.align 2, 0
_0800EFB8: .4byte gDispIo
_0800EFBC:
	ldr r2, _0800F0BC  @ gDispIo
	ldrb r1, [r2, #1]
	movs r0, #2
	negs r0, r0
	ands r0, r1
...
_0800EFE2:
	...
	bx r0
	.align 2, 0
_0800F0BC: .4byte gDispIo
_0800F0C0: .4byte gBg2Tm
...
Event22_CLEAN: @ 0x0800F0C8
	...
	ldrh r0, [r0]
	bl sub_800BCDC
	ldr r0, _0800F118  @ gBg0Tm
	movs r1, #0
	bl TmFill
	ldr r0, _0800F11C  @ gBg1Tm
	movs r1, #0
	bl TmFill
	movs r0, #1
	bl EnableBgSync
...
_0800F198:
	...
	ldrh r0, [r0]
	bl sub_800BCDC
	ldr r0, _0800F204  @ gBg0Tm
	movs r1, #0
	bl TmFill
	ldr r0, _0800F208  @ gBg1Tm
	movs r1, #0
	bl TmFill
	movs r0, #1
	bl EnableBgSync
...
_0800F204: .4byte gBg0Tm
_0800F208: .4byte gBg1Tm
...
_0800FBFA:
	...
	bl UNIT_Filter
	adds r5, r0, #0
	ldr r0, _0800FC48  @ gMapMovement2
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldrh r2, [r6, #0x3c]
...
_0800FC4C:
	...
	orrs r0, r1
	strb r0, [r4]
	ldr r1, _0800FC8C  @ LoadUnitsIdle
	str r1, [r6, #0x2c]
	adds r0, r6, #0
	bl _call_via_r1
_0800FC72:
...
_0800FE7C:
	...
	lsls r0, r0, #0x10
	lsrs r4, r0, #0x10
	ldr r0, _0800FEBC  @ gMapMovement2
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldrh r0, [r7, #0x3c]
...
_0800FF36:
	...
	bl RefreshUnitSprites
	bl RenderBmMap
	ldr r0, _0800FF5C  @ gMapMovement2
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	movs r0, #2
...
_0800FFA0:
	...
	bl m4aSongNumStart
_0800FFB2:
	ldr r2, _0800FFCC  @ gEventRangeDisplayUnit
...
_0800FFCC: .4byte gEventRangeDisplayUnit
_0800FFD0: .4byte gActiveUnit
_0800FFD4:
	bl HideMoveRangeGraphics
	ldr r2, _0800FFF0  @ gEventRangeDisplayUnit
	ldr r1, [r2]
	cmp r1, #0
	beq _0800FFE6
...
_0800FFE8:
	...
	bx r1
	.align 2, 0
_0800FFF0: .4byte gEventRangeDisplayUnit
...
_080108EC:
	...
	ldrb r0, [r0]
	movs r1, #1
	ldr r2, _0801091C  @ MenuCommandNeverUsable
...
_0801091C: .4byte MenuCommandNeverUsable
_08010920:
	movs r5, #0
_08010922:
	adds r0, r7, #0
	...
	ldrb r0, [r4]
	movs r1, #1
	ldr r2, _08010960  @ MenuCommandAlwaysGrayed
	bl SetMenuCommandOverride
	ldrb r0, [r4]
	movs r1, #2
...
_08010950:
	...
	bx r1
	.align 2, 0
_08010960: .4byte MenuCommandAlwaysGrayed
