...
_08012BCC:
	...
	b _08012BE6
	.align 2, 0
_08012BD8: .4byte gBmSt
_08012BDC:
	ldr r0, _08012BEC  @ gBmSt
	ldrh r1, [r0, #0xe]
	movs r2, #2
	eors r1, r2
	strh r1, [r0, #0xe]
...
sub_80133A0: @ 0x080133A0
	push {r4, r5, r6, r7, lr}
	adds r3, r0, #0
	ldr r7, _080133BC  @ gBuf
	movs r6, #0
	adds r5, r7, #0
	ldr r4, _080133C0  @ gPal
_080133AC:
	ldrh r1, [r4]
	movs r0, #0x1f
	ands r0, r1
	...
	b _080133C8
	.align 2, 0
_080133BC: .4byte gBuf
_080133C0: .4byte gPal
_080133C4:
...
GetPaletteFadeBuffer: @ 0x0801344C
	ldr r0, _08013450  @ gPaletteFadeBuffer
	bx lr
	.align 2, 0
_08013450: .4byte gPaletteFadeBuffer
...
sub_8013928: @ 0x08013928
	...
	adds r4, r4, r5
	lsls r4, r4, #4
	ldr r0, _0801397C  @ gPaletteFadeBuffer
	adds r4, r4, r0
	ldr r0, _08013980  @ gUnknown_0859A00C
	bl SpawnProc
	mov r8, r0
	lsls r5, r5, #5
	ldr r0, _08013984  @ gPal
	adds r5, r5, r0
	adds r0, r5, #0
	adds r1, r4, #0
	movs r2, #0x10
	...
	bx r1
	.align 2, 0
_0801397C: .4byte gPaletteFadeBuffer
_08013980: .4byte gUnknown_0859A00C
_08013984: .4byte gPal
...
sub_8013E30: @ 0x08013E30
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013E44  @ BlackenScreen
	movs r0, #1
	movs r1, #4
	bl StartSafeFade
	pop {r0}
...
sub_8013E48: @ 0x08013E48
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013E5C  @ BlackenScreen
	movs r0, #1
	movs r1, #8
	bl StartSafeFade
	pop {r0}
...
sub_8013E60: @ 0x08013E60
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013E74  @ BlackenScreen
	movs r0, #1
	movs r1, #0x10
	bl StartSafeFade
	pop {r0}
...
sub_8013E78: @ 0x08013E78
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013E8C  @ BlackenScreen
	movs r0, #1
	movs r1, #0x20
	bl StartSafeFade
	pop {r0}
...
sub_8013E90: @ 0x08013E90
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013EA4  @ BlackenScreen
	movs r0, #1
	movs r1, #0x40
	bl StartSafeFade
	pop {r0}
...
sub_8013EF8: @ 0x08013EF8
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013F0C  @ BlackenScreen
	movs r0, #3
	movs r1, #4
	bl StartSafeFade
	pop {r0}
...
sub_8013F10: @ 0x08013F10
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013F24  @ BlackenScreen
	movs r0, #3
	movs r1, #8
	bl StartSafeFade
	pop {r0}
...
sub_8013F28: @ 0x08013F28
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013F3C  @ BlackenScreen
	movs r0, #3
	movs r1, #0x10
	bl StartSafeFade
	pop {r0}
...
sub_8013F40: @ 0x08013F40
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013F54  @ BlackenScreen
	movs r0, #3
	movs r1, #0x20
	bl StartSafeFade
	pop {r0}
...
StartSafeFadeInBlack: @ 0x08013F58
	push {lr}
	adds r2, r0, #0
	ldr r3, _08013F6C  @ BlackenScreen
	movs r0, #3
	movs r1, #0x40
	bl StartSafeFade
	pop {r0}
...
BlackenScreen: @ 0x080141B0
	...
	movs r0, #1
	bl SetBlendBackdropA
	ldr r1, _08014204  @ gPal
	movs r0, #0
	strh r0, [r1]
	bl EnablePalSync
	ldr r2, _08014208  @ gDispIo
	ldrb r1, [r2, #1]
	movs r0, #2
	negs r0, r0
	ands r0, r1
	...
	bx r0
	.align 2, 0
_08014204: .4byte gPal
_08014208: .4byte gDispIo
...
SomeDrawTextCentered: @ 0x080143D8
	...
	adds r4, r2, #0
	adds r6, r3, #0
	ldr r5, _08014438  @ gSomeUtilityTextHandle
	adds r0, r5, #0
	adds r1, r4, #0
	bl InitText
	adds r0, r6, #0
	...
	bx r1
	.align 2, 0
_08014438: .4byte gSomeUtilityTextHandle
...
SomeDrawTextInlineAutoWidth: @ 0x0801443C
	...
	adds r6, r1, #0
	adds r5, r2, #0
	ldr r4, _0801447C  @ gSomeUtilityTextHandle
	adds r0, r5, #0
	bl GetStringTextLen
	adds r1, r0, #7
	cmp r1, #0
...
_08014454:
	...
	bx r1
	.align 2, 0
_0801447C: .4byte gSomeUtilityTextHandle
...
_08014A2E:
	...
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A3C  @ gBg0Tm
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A3C: .4byte gBg0Tm
_08014A40:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A4C  @ gBg1Tm
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A4C: .4byte gBg1Tm
_08014A50:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A5C  @ gBg2Tm
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A5C: .4byte gBg2Tm
_08014A60:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A6C  @ gBg3Tm
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A6C: .4byte gBg3Tm
_08014A70:
	movs r0, #0
_08014A72:
	pop {r1}
...
_0801531A:
	...
	bx r0
	.align 2, 0
_08015350: .4byte gKeySt
_08015354: .4byte gProcTreeRootArray
_08015358: .4byte gBmSt
...
ResetHLayers: @ 0x08015608
	push {lr}
	ldr r0, _08015644  @ gPlaySt
	ldrb r0, [r0, #0x15]
	cmp r0, #7
	bne _0801564C
	ldr r3, _08015648  @ gDispIo
	ldrb r1, [r3, #0xc]
	movs r2, #4
	negs r2, r2
	adds r0, r2, #0
	...
	b _08015678
	.align 2, 0
_08015644: .4byte gPlaySt
_08015648: .4byte gDispIo
_0801564C:
	ldr r3, _0801567C  @ gDispIo
	ldrb r2, [r3, #0xc]
	movs r1, #4
	negs r1, r1
	adds r0, r1, #0
