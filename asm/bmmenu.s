...
EffectWait: @ 0x08022738
	ldr r1, _08022744  @ gAction
	movs r0, #1
	strb r0, [r1, #0x11]
	movs r0, #0x17
	bx lr
	.align 2, 0
_08022744: .4byte gAction
...
DisplayUnitStandingAttackRange: @ 0x08022C30
	push {r4, r5, lr}
	ldr r0, _08022C6C  @ gMapMovement
	ldr r0, [r0]
	movs r5, #1
	negs r5, r5
	adds r1, r5, #0
	bl BmMapFill
	ldr r0, _08022C70  @ gMapRange
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	...
	b _08022C88
	.align 2, 0
_08022C6C: .4byte gMapMovement
_08022C70: .4byte gMapRange
...
AttackWeaponSelect_ItemOnSwitchIn: @ 0x08022D84
	...
	ldr r0, _08022DCC  @ gMapMovement
	ldr r0, [r0]
	movs r1, #1
	negs r1, r1
	bl BmMapFill
	ldr r0, _08022DD0  @ gMapRange
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	...
	bx r1
	.align 2, 0
_08022DCC: .4byte gMapMovement
_08022DD0: .4byte gMapRange
...
VisitCommandEffect: @ 0x080230C0
	...
	cmp r0, #2
	beq _080230DC
	ldr r1, _080230D8  @ gAction
	movs r0, #0x10
	strb r0, [r1, #0x11]
	movs r0, #0x17
	b _080230E6
	.align 2, 0
_080230D8: .4byte gAction
_080230DC:
...
_080237A4: .4byte gAction
_080237A8:
	bl ClearBg0Bg1
	ldr r0, _080237EC  @ gActiveUnit
	ldr r0, [r0]
	ldr r1, _080237F0  @ gAction
	ldrb r2, [r1, #0x12]
	lsls r2, r2, #1
	adds r1, r0, #0
	adds r1, #0x1e
...
_080237F0: .4byte gAction
_080237F4: .4byte gPlaySt
...
ItemSubMenu_TradeItem: @ 0x08023838
	...
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r0, _08023864  @ gBmSt
	ldr r1, _08023868  @ gAction
	ldrb r1, [r1, #0x12]
	adds r0, #0x3f
	strb r1, [r0]
	adds r0, r4, #0
	...
	bx r1
	.align 2, 0
_08023864: .4byte gBmSt
_08023868: .4byte gAction
...
FillBallistaRange: @ 0x080239CC
	...
	mov r6, r8
	push {r6}
	ldr r0, _08023A48  @ gMapMovement
	ldr r0, [r0]
	movs r1, #1
	negs r1, r1
	bl BmMapFill
	ldr r4, _08023A4C  @ gMapRange
	ldr r0, [r4]
	movs r1, #0
	bl BmMapFill
	ldr r0, [r4]
	...
	bx r1
	.align 2, 0
_08023A48: .4byte gMapMovement
_08023A4C: .4byte gMapRange
...
StaffCommandRange: @ 0x08023B3C
	...
	adds r6, r0, #0
	ldr r0, _08023B7C  @ gMapMovement
	ldr r0, [r0]
	adds r1, r4, #0
	bl BmMapFill
	ldr r0, _08023B80  @ gMapRange
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldr r0, [r5]
...
_08023B7C: .4byte gMapMovement
_08023B80: .4byte gMapRange
...
StaffItemSelect_OnHover: @ 0x08023C14
	...
	ldrsb r0, [r4, r0]
	bl UpdateMenuItemPanel
	ldr r0, _08023C60  @ gMapMovement
	ldr r0, [r0]
	movs r1, #1
	negs r1, r1
	bl BmMapFill
	ldr r0, _08023C64  @ gMapRange
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldr r0, [r5]
...
_08023C60: .4byte gMapMovement
_08023C64: .4byte gMapRange
...
ConvoyMenu_HelpBox: @ 0x08024588
	...
	ldrsh r1, [r1, r2]
	lsls r1, r1, #3
	ldr r2, _080245B0  @ gBmSt
	ldrh r2, [r2, #0x2c]
	bl ShowItemHelpBox
	movs r0, #0
	b _080245D4
	.align 2, 0
_080245B0: .4byte gBmSt
_080245B4:
	movs r2, #0x2a
	ldrsh r0, [r1, r2]
	lsls r0, r0, #3
...
ItemMenuHelpBox: @ 0x08024BF8
	...
	cmp r0, #0
	bne _08024C14
	ldr r0, _08024C10  @ gBmSt
	ldrh r2, [r0, #0x2c]
	b _08024C26
	.align 2, 0
_08024C10: .4byte gBmSt
_08024C14:
