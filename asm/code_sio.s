...
_080416B0: .4byte gSioBaudRate
_080416B4:
	ldr r0, _080416CC  @ gSioBaudRate
	ldrb r0, [r0]
	movs r5, #0xc1
	lsls r5, r5, #7
	adds r1, r5, #0
...
sub_8041900: @ 0x08041900
	...
	subs r0, #1
	str r0, [r1]
	ldr r1, _08041970  @ OnSerialCommunication
	movs r0, #7
	bl SetIrqFunc
	ldr r1, _08041974  @ SioReady
	movs r0, #6
	bl SetIrqFunc
...
_08041970: .4byte OnSerialCommunication
_08041974: .4byte SioReady
...
sub_8043044: @ 0x08043044
	...
	movs r2, #0
	bl SetBgOffset
	ldr r0, _08043090  @ gBg0Tm
	movs r1, #0
	bl TmFill
	ldr r0, _08043094  @ gBg1Tm
	movs r1, #0
	bl TmFill
	ldr r0, _08043098  @ gBg2Tm
	movs r1, #0
	bl TmFill
	movs r0, #7
	bl EnableBgSync
	...
	bx r0
	.align 2, 0
_08043090: .4byte gBg0Tm
_08043094: .4byte gBg1Tm
_08043098: .4byte gBg2Tm
...
sub_804309C: @ 0x0804309C
	...
	movs r2, #0
	bl SetBgOffset
	ldr r0, _080430F0  @ gBg0Tm
	movs r1, #0
	bl TmFill
	ldr r0, _080430F4  @ gBg1Tm
	movs r1, #0
	bl TmFill
	ldr r0, _080430F8  @ gBg2Tm
	movs r1, #0
	bl TmFill
	ldr r0, _080430FC  @ gBg3Tm
	movs r1, #0
	bl TmFill
	movs r0, #0xf
	bl EnableBgSync
	...
	bx r0
	.align 2, 0
_080430F0: .4byte gBg0Tm
_080430F4: .4byte gBg1Tm
_080430F8: .4byte gBg2Tm
_080430FC: .4byte gBg3Tm
...
sub_8043904: @ 0x08043904
	...
	sub sp, #0xc
	adds r7, r0, #0
	ldr r5, _08043AD0  @ Pal_SystemText
	bl sub_8043044
	bl sub_804C33C
	movs r4, #0
	str r4, [sp]
...
_08043968:
	...
	bge _08043968
	bl EnablePalSync
	ldr r0, _08043AF8  @ gFont_203DB64
	bl SetTextFont
...
_08043AF4: .4byte gPal
_08043AF8: .4byte gFont_203DB64
_08043AFC: .4byte gUnknown_0203DA24
_08043B00: .4byte gDispIo
...
_08043F84:
	...
	cmp r1, r0
	bge _08043FC8
	ldr r0, _08043FC4  @ gKeySt
	ldr r2, [r0]
	ldrh r1, [r2, #6]
	movs r0, #0x80
	b _08043FD0
	.align 2, 0
_08043FC4: .4byte gKeySt
_08043FC8:
	ldr r0, _08043FDC  @ gKeySt
	ldr r2, [r0]
	ldrh r1, [r2, #6]
	movs r0, #0x40
_08043FD0:
...
_08044484:
	...
	b _08044524
	.align 2, 0
_080444D4: .4byte gKeySt
_080444D8: .4byte gBg0Tm+0x1E
_080444DC:
	movs r0, #1
	ands r0, r1
	cmp r0, #0
...
NameSelect_DrawNameText: @ 0x08044700
	...
	adds r4, r0, #0
	adds r4, #0x3d
	ldr r5, _08044748  @ gNameSelectNameBoxText
	adds r0, r5, #0
	bl ClearText
	ldrb r0, [r4]
	cmp r0, #0
...
_08044718:
	...
	bne _08044718
_08044732:
	ldr r0, _08044748  @ gNameSelectNameBoxText
	ldr r1, _0804474C  @ gBg0Tm+0x158
	bl PutText
	movs r0, #1
	bl EnableBgSync
	pop {r4, r5, r6}
	...
	bx r0
	.align 2, 0
_08044748: .4byte gNameSelectNameBoxText
_0804474C: .4byte gBg0Tm+0x158
...
NameSelect_8044768: @ 0x08044768
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _080447EC  @ gBg2Tm+0x200
	ldr r1, _080447F0  @ gUnknown_085AE190
	movs r2, #0x80
	lsls r2, r2, #5
	bl TmApplyTsa_t
	ldr r0, _080447F4  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
...
_080447EC: .4byte gBg2Tm+0x200
_080447F0: .4byte gUnknown_085AE190
_080447F4: .4byte gFont_203DB64
_080447F8:
...
_0804486E:
	...
	mov r1, r8
	strb r0, [r1]
	ldr r0, _08044958  @ gNameSelectNameBoxText
	movs r1, #8
	bl InitText
	movs r0, #1
	strb r0, [r7]
...
_08044958: .4byte gNameSelectNameBoxText
...
NameSelect_8044FE4: @ 0x08044FE4
	...
	movs r1, #0
	strb r1, [r0]
	ldr r0, _08044FF8  @ OnNameSelectHBlank
	bl SetOnHBlankA
	pop {r0}
	bx r0
	.align 2, 0
_08044FF8: .4byte OnNameSelectHBlank
...
_08045158:
	...
	b _080451E6
	.align 2, 0
_08045198: .4byte gKeySt
_0804519C: .4byte gBg0Tm+0x316
_080451A0:
	movs r0, #1
	ands r0, r1
	cmp r0, #0
...
sub_8045640: @ 0x08045640
	...
	ldr r4, _080457D4  @ gBuf
	adds r1, r4, #0
	bl Decompress
	ldr r0, _080457D8  @ gBg3Tm
	movs r2, #0xa0
	lsls r2, r2, #8
	adds r1, r4, #0
	bl TmApplyTsa_t
	...
	ldr r0, _080457E4  @ Pal_SystemText
	movs r1, #0xf0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
...
_08045DFC:
	...
	add r1, sp, #4
	bl sub_80A66F4
	ldr r0, _08045EEC  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	bl sub_8043164
...
_08045F90: .4byte gKeySt
_08045F94:
	ldr r0, _08046000  @ gKeySt
	ldr r0, [r0]
	ldrh r1, [r0, #8]
	movs r0, #2
	ands r0, r1
...
sub_8046838: @ 0x08046838
	...
	ldr r4, _08046988  @ gBuf
	adds r1, r4, #0
	bl Decompress
	ldr r0, _0804698C  @ gBg2Tm+0x142
	movs r2, #0x80
	lsls r2, r2, #5
	adds r1, r4, #0
	bl TmApplyTsa_t
	ldr r0, _08046990  @ gFont_203DB64
	bl SetTextFont
	bl ResetTextFont
	bl sub_8043164
	bl sub_804CEB0
...
_08046988: .4byte gBuf
_0804698C: .4byte gBg2Tm+0x142
_08046990: .4byte gFont_203DB64
_08046994: .4byte gUnknown_080D9E50
_08046998: .4byte gUnknown_0203DA30
_0804699C: .4byte gBg0Tm+0xC
_080469A0: .4byte gBg1Tm+0x23C
...
sub_80469C4: @ 0x080469C4
	...
	bl Decompress
	ldr r0, _08046AC0  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	movs r0, #0xc0
...
_08046BB0:
	...
	bx r0
	.align 2, 0
_08046C58: .4byte gBg1Tm+0x6
_08046C5C: .4byte gBg0Tm+0x6
_08046C60: .4byte gDispIo
...
sub_8047008: @ 0x08047008
	...
	movs r2, #0x80
	bl ApplyPaletteExt
	ldr r0, _080471D8  @ gBg2Tm+0x102
	ldr r1, _080471DC  @ gUnknown_085AE464
	movs r2, #0x80
	lsls r2, r2, #5
	bl TmApplyTsa_t
	ldr r0, _080471E0  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	movs r1, #0
...
_080471D8: .4byte gBg2Tm+0x102
_080471DC: .4byte gUnknown_085AE464
_080471E0: .4byte gFont_203DB64
...
sub_8047324: @ 0x08047324
	...
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, _08047540  @ gBg2Tm+0x102
	ldr r1, _08047544  @ gUnknown_085AE464
	movs r2, #0x80
	lsls r2, r2, #5
	bl TmApplyTsa_t
	ldr r0, _08047548  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	adds r1, r7, #0
...
_080473D2:
	...
	movs r2, #0
	bl Text_InsertDrawString
	ldr r1, _08047564  @ gBg0Tm+0x14A
	adds r0, r4, #0
	bl PutText
	ldr r0, _08047568  @ gUnknown_0203DC44
	bl sub_80A69DC
	bl sub_8046F68
	ldr r1, _0804756C  @ gDispIo
	mov ip, r1
	ldrb r0, [r1, #1]
	movs r1, #0x20
	orrs r0, r1
...
_08047540: .4byte gBg2Tm+0x102
_08047544: .4byte gUnknown_085AE464
_08047548: .4byte gFont_203DB64
...
_08047564: .4byte gBg0Tm+0x14A
_08047568: .4byte gUnknown_0203DC44
_0804756C: .4byte gDispIo
...
sub_8047780: @ 0x08047780
	...
	ldr r4, _08047908  @ gBuf
	adds r1, r4, #0
	bl Decompress
	ldr r0, _0804790C  @ gBg2Tm+0x142
	movs r2, #0x80
	lsls r2, r2, #5
	adds r1, r4, #0
	bl TmApplyTsa_t
	ldr r0, _08047910  @ gFont_203DB64
	bl SetTextFont
	bl ResetTextFont
	bl sub_8043164
	mov r1, r8
...
_08047908: .4byte gBuf
_0804790C: .4byte gBg2Tm+0x142
_08047910: .4byte gFont_203DB64
_08047914: .4byte gUnknown_080D9E50
_08047918: .4byte gUnknown_0203DA30
_0804791C: .4byte gBg0Tm+0xC
_08047920: .4byte gBg1Tm+0x23C
...
SioMenu_8047B34: @ 0x08047B34
	...
	movs r2, #0x60
	bl ApplyPaletteExt
	ldr r0, _08047BD4  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	bl sub_8043164
...
SioMenu_8047D88: @ 0x08047D88
	...
	movs r2, #0x60
	bl ApplyPaletteExt
	ldr r0, _08047E30  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
	bl ResetTextFont
	bl sub_8043164
...
sub_80481E0: @ 0x080481E0
	...
	ldr r0, _08048248  @ gFont_203DB64
...
sub_8048280: @ 0x08048280
	...
	bl ClearGameLinkArenaBit
	ldr r0, _080482CC  @ gFont_203DB64
...
sub_8048604: @ 0x08048604
	...
	sub sp, #4
	adds r6, r0, #0
	ldr r0, _08048648  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
...
sub_8048730: @ 0x08048730
	...
	movs r3, #6
	bl DrawUiFrame2
	ldr r0, _0804878C  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
...
_080487D0:
	...
	movs r0, #3
	strb r0, [r1]
	ldr r0, _08048814  @ gFont_203DB64
	bl SetTextFont
	bl InitSystemTextFont
...
_0804894C:
	...
	bx r0
	.align 2, 0
_08048980: .4byte gBg1Tm
_08048984: .4byte gBg0Tm
...
sub_8048EB8: @ 0x08048EB8
	...
	bl Interpolate
	mov sl, r0
	ldr r4, _08048FB8  @ gSinLut
	ldr r2, _08048FBC  @ gSinLut+0x80
	movs r1, #0
	ldrsh r0, [r2, r1]
	lsls r0, r0, #4
	mov r1, r8
...
_08048FA6:
	...
	bx r0
	.align 2, 0
_08048FB8: .4byte gSinLut
_08048FBC: .4byte gSinLut+0x80
_08048FC0: .4byte Sprite_32x16
_08048FC4: .4byte 0x00009350
_08048FC8: .4byte 0x00009354
_08048FCC: .4byte Sprite_16x16
...
_080490C2:
	...
	bx r0
	.align 2, 0
_080490D4: .4byte gSinLut
_080490D8: .4byte Sprite_32x16
_080490DC: .4byte 0x00009350
_080490E0: .4byte 0x00009354
_080490E4: .4byte Sprite_16x16
...
sub_80490EC: @ 0x080490EC
	...
	movs r0, #0
	mov sl, r0
	ldr r0, _080491C4  @ Pal_SystemText
	movs r1, #0xc8
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
...
_080491A4:
	...
	b _080491F0
	.align 2, 0
_080491C4: .4byte Pal_SystemText
...
sub_8049594: @ 0x08049594
	push {r4, lr}
	ldr r0, _080495EC  @ gMapUnit
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldr r0, _080495F0  @ gMapFog
	ldr r0, [r0]
	movs r1, #1
	bl BmMapFill
	movs r4, #1
...
_080495E0:
	...
	bx r0
	.align 2, 0
_080495EC: .4byte gMapUnit
_080495F0: .4byte gMapFog
...
_0804A19C: .4byte gDispIo
_0804A1A0:
	adds r0, r5, #0
	bl Proc_Break
	ldr r2, _0804A1CC  @ gDispIo
	ldrb r1, [r2, #1]
	movs r0, #2
	negs r0, r0
	ands r0, r1
...
_0804A3E6:
	...
	b _0804A426
	.align 2, 0
_0804A3F4: .4byte gDispIo
_0804A3F8: .4byte gKeySt
...
_0804A798: .4byte gBattleUnitA
_0804A79C: .4byte gBattleUnitB
_0804A7A0:
...
_0804B660:
	...
	bl MU_Create
	adds r4, r0, #0
	ldr r1, _0804B6A4  @ gUnitMoveBuffer
	movs r0, #2
	strb r0, [r1]
	movs r0, #4
	strb r0, [r1, #1]
...
_0804B69C:
	...
	bx r0
	.align 2, 0
_0804B6A4: .4byte gUnitMoveBuffer
...
_0804B86C:
	...
	ldr r1, _0804B8CC  @ gUnitMoveBuffer
	strb r0, [r1]
	movs r0, #4
	strb r0, [r1, #1]
	adds r0, r4, #0
...
_0804B8B8:
	...
	bx r0
	.align 2, 0
_0804B8C0: .4byte gBattleUnitA
_0804B8C4: .4byte gProcScr_MoveUnit
_0804B8C8: .4byte gBattleUnitB
_0804B8CC: .4byte gUnitMoveBuffer
...
sub_804B8D0: @ 0x0804B8D0
	push {r4, r5, lr}
	ldr r0, _0804B918  @ gBattleUnitA
	ldrb r0, [r0, #0xb]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetUnit
	adds r4, r0, #0
	ldr r0, _0804B91C  @ gBattleUnitB
	ldrb r0, [r0, #0xb]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetUnit
...
_0804B912:
	...
	bx r0
	.align 2, 0
_0804B918: .4byte gBattleUnitA
_0804B91C: .4byte gBattleUnitB
...
_0804C6AA:
	...
	ldrsh r4, [r7, r2]
	adds r4, #8
	ldr r6, _0804C74C  @ Sprite_8x16_HFlipped
	ldrh r0, [r7, #0x38]
	lsrs r0, r0, #5
	movs r1, #6
	bl __umodsi3
...
_0804C748: .4byte Sprite_8x16
_0804C74C: .4byte Sprite_8x16_HFlipped
...
_0804C9F8: .4byte gPal
_0804C9FC: .4byte gUnknown_08A1BD40
_0804CA00: .4byte gSinLut
...
sub_804D3DC: @ 0x0804D3DC
	push {lr}
	ldr r1, _0804D3EC  @ gMpi_MapBgm
	movs r0, #0x34
	bl StartBgm
	pop {r0}
	bx r0
	.align 2, 0
_0804D3EC: .4byte gMpi_MapBgm
...
_0804D64C: .4byte gSinLut+0x80
_0804D650: .4byte gSinLut
...
_0804D9BC: .4byte gBg0Tm
_0804D9C0: .4byte gBg1Tm
